# the same as create_db_samlples but with random start_time for tasks
...
def main():
    ...
    values = [[f'task{i}', str(datetime(2019, randint(1,12), randint(1,25), 0, 0).date()), randint(1, 10), [], f'description of task {i}',
